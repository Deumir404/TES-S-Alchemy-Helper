...
def write_json(data, filename= 'ingredients5.json'):
...
def get_url(url):
    # try :
        ...
        path = "/html/body/div[4]/div[4]/div[3]/main/div[3]/div[2]/div[1]/div[1]/table[5]/tbody/tr"
        ...
        for r in range(1, rows):
            ...
            for i in list:
                ...
                if i == 2:
                    ...
                    prop = driver.find_element(By.XPATH, value = path+ '['+ str(r)+f']/td[{i}]').text
                    property.append(prop)
            data = dict(name_potion = name, image = src , properties_json = property)
            print(data)
...
def main():
        ...
        url = "https://elderscrolls.fandom.com/ru/wiki/%D0%98%D0%BD%D0%B3%D1%80%D0%B5%D0%B4%D0%B8%D0%B5%D0%BD%D1%82%D1%8B_(Skyrim)#%D0%92_The_Elder_Scrolls_V:_Dawnguard"
        get_url(url)
        print("Complete")
